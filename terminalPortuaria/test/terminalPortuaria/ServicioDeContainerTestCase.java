...
public class ServicioDeContainerTestCase {
    ...
    void testTodosLosServicios() {
        ...
        assertEquals(200.0, electricidad.calcularCostoVariable(reefer));
        assertEquals(300.0, costoElectricidad, "Electricidad: base 100 + 200 variable");
        ...
        assertEquals(6300.0, costoTotalServicios, 0.001, "Suma total de todos los servicios");
    }
}